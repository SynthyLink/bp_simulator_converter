...
namespace Trading.Database.Interfaces
{
    ...
    public interface ITradingDatabaseHistoryInteface
    {
        ...
        Task<List<HistoricalDataMessageDateTime>> GetHistoricalDataMessageDateTimes(Guid id,
            DateTime begin, DateTime end, CancellationToken token);

        List<HistoricalDataMessageDateTime> GetHistoricalDataMessageDateTimes(Guid id,
