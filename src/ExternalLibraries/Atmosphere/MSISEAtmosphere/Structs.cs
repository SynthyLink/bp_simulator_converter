...
{
    public struct nrlmsise_flags
    {
        public nrlmsise_flags() { }
    ...
    struct nrlmsise_input
    {
        ...
        public ap_array ap_a; /* see above */
    };
    /*
    ...
    {
        public nrlmsise_output() { }
        double[] d = new double[9];   /* densities */
        double[] t = new double[2];   /* temperatures */
    };
    /* 
     *   OUTPUT VARIABLES:
