...
class Immelman_CategoryArrow_8 extends BelongsToCollection
{
	constructor(desktop: IDesktop, name: string)
	{
		super(desktop, name);
...
class Immelman_CategoryArrow_10 extends DataLink
{
	constructor(desktop: IDesktop, name: string)
	{
		super(desktop, name);
...
class Immelman_CategoryArrow_11 extends ReferenceFrameArrow
{
	constructor(desktop: IDesktop, name: string)
	{
		super(desktop, name);
...
finish() : void
{
		...
		let s8 = this.mapObjects.get("Immelman_CategoryObject_5")
		if(s8 != undefined)    arrows[8].setSource(s8);
		let t8 = this.mapObjects.get("Immelman_CategoryObject_6")
		...
		let t9 = this.mapObjects.get("Immelman_CategoryObject_7")
		if(t9 != undefined)    arrows[9].setTarget(t9);
		let s10 = this.mapObjects.get("Immelman_CategoryObject_1")
		if(s10 != undefined)    arrows[10].setSource(s10);
		let t10 = this.mapObjects.get("Immelman_CategoryObject_0")
		if(t10 != undefined)    arrows[10].setTarget(t10);
		let s11 = this.mapObjects.get("Immelman_CategoryObject_4")
		...
		let t14 = this.mapObjects.get("Immelman_CategoryObject_4")
		...
		let t15 = this.mapObjects.get("Immelman_CategoryObject_8")
