...
export declare class PerformerMeasuremets extends Performer {
    ...
    performIteratorDataConsumerMapArrayAsync(dataConsumer: IDataConsumer, iterator: IIterator, abort: AbortController, meaurements: string[], preparation?: IAction | undefined): Promise<Map<string, any>[]>;
    performIteratorDataConsumerMapAsync(dataConsumer: IDataConsumer, iterator: IIterator, abort: AbortController, meaurements: Map<string, string>, preparation?: IAction | undefined): Promise<Map<string, any>[]>;
    performIteratorDataConsumerAsync(dataConsumer: IDataConsumer, iterator: IIterator, abort: AbortController, action: IAction, preparation?: IAction | undefined): Promise<void>;
