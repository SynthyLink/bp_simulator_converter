...
class Cessna_CategoryObject_3 extends BasicCamera_1.BasicCamera {
    constructor(desktop, name) {
        super(desktop, name);
    }
}
class Cessna_CategoryObject_4 extends TimerObject_1.TimerObject {
    constructor(desktop, name) {
        super(desktop, name);
        this.span = new TimeSpan_1.TimeSpan(100);
    }
}
class Cessna_CategoryObject_5 extends RigidReferenceFrame_1.RigidReferenceFrame {
    constructor(desktop, name) {
        super(desktop, name);
...
class Cessna_CategoryObject_6 extends VectorFormulaConsumer_1.VectorFormulaConsumer {
    constructor(desktop, name) {
        super(desktop, name);
        this.var_0 = 0;
        let map = new Map([]);
...
class Cessna_CategoryObject_7 extends DataConsumer_1.DataConsumer {
    constructor(desktop, name) {
        super(desktop, name);
    }
}
...
class Cessna extends Desktop_1.Desktop {
    constructor() {
        ...
        this.mapObjects.set("Cessna_CategoryObject_0_Visible0", new Cessna_CategoryObject_0_Visible0(this, "pLANE"));
        this.mapObjects.set("Cessna_CategoryObject_0_Visible0", new Cessna_CategoryObject_0_Visible0(this, "pLANE"));
        this.mapObjects.set("Cessna_CategoryObject_3", new Cessna_CategoryObject_3(this, "Camera"));
        this.mapObjects.set("Cessna_CategoryObject_4", new Cessna_CategoryObject_4(this, "Timer"));
        this.mapObjects.set("Cessna_CategoryObject_5", new Cessna_CategoryObject_5(this, ""));
        this.mapObjects.set("Cessna_CategoryObject_6", new Cessna_CategoryObject_6(this, "Time"));
        this.mapObjects.set("Cessna_CategoryObject_7", new Cessna_CategoryObject_7(this, "Chart"));
    ...
    finish() {
        ...
        let s0 = this.mapObjects.get("Cessna_CategoryObject_3");
        if (s0 != undefined)
            arrows[0].setSource(s0);
        let t0 = this.mapObjects.get("Cessna_CategoryObject_5");
        if (t0 != undefined)
            arrows[0].setTarget(t0);
        let s1 = this.mapObjects.get("Cessna_CategoryObject_3");
        if (s1 != undefined)
            arrows[1].setSource(s1);
        let t1 = this.mapObjects.get("Cessna_CategoryObject_0_Visible0");
        if (t1 != undefined)
            arrows[1].setTarget(t1);
        let s2 = this.mapObjects.get("Cessna_CategoryObject_7");
        if (s2 != undefined)
            arrows[2].setSource(s2);
        let t2 = this.mapObjects.get("Cessna_CategoryObject_3");
        if (t2 != undefined)
            arrows[2].setTarget(t2);
        let s3 = this.mapObjects.get("Cessna_CategoryObject_7");
        if (s3 != undefined)
            arrows[3].setSource(s3);
        let t3 = this.mapObjects.get("Cessna_CategoryObject_5");
        if (t3 != undefined)
            arrows[3].setTarget(t3);
        let s4 = this.mapObjects.get("Cessna_CategoryObject_7");
        if (s4 != undefined)
            arrows[4].setSource(s4);
        let t4 = this.mapObjects.get("Cessna_CategoryObject_0");
        if (t4 != undefined)
            arrows[4].setTarget(t4);
        let s5 = this.mapObjects.get("Cessna_CategoryObject_7");
        if (s5 != undefined)
            arrows[5].setSource(s5);
        let t5 = this.mapObjects.get("Cessna_CategoryObject_6");
        if (t5 != undefined)
            arrows[5].setTarget(t5);
        let s6 = this.mapObjects.get("Cessna_CategoryObject_7");
        if (s6 != undefined)
            arrows[6].setSource(s6);
        let t6 = this.mapObjects.get("Cessna_CategoryObject_4");
        if (t6 != undefined)
