...
function App() {
    ...
    const btnClick = async () => {
        ...
        const init: OrbitalForecastConditionNumber = { begin: performer.dateNumber(begin), end: performer.dateNumber(end), x: x, y: y, z: z, vx: vx, vy: vy, vz: vz };
        if (init === undefined) {
            return;
        }
    ...
    return (
        ...
        <div className="body-main">
            ...
            <div className="orbital-parameters">
                {contents} <button onClick={btnClick}>Start</button>
            </div>
