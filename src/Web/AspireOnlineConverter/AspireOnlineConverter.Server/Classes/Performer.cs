...
namespace AspireOnlineConverter.Server.Classes
{
    public class Performer : Diagram.UI.Performer
    {
            ...
            Tuple<DataPerformer.Portable.Wrappers.DataConsumerWrapper, ITimeMeasurementProvider,
               IDifferentialEquationProcessor, string, Dictionary<string, Func<double>>, double, int> PrepareCalculation(OrbitalForecastCondition condition)
            {
                ...
                var chart = GetObject<IDataConsumer>(orb, "Chart");

                var wrapper = new DataPerformer.Portable.Wrappers.DataConsumerWrapper(chart);

                ITimeMeasurementProvider timeprovider = new DataPerformer.Portable.Helpers.TimeMeasurementProvider();
                ...
                return new Tuple<DataPerformer.Portable.Wrappers.DataConsumerWrapper, ITimeMeasurementProvider, IDifferentialEquationProcessor, string,
