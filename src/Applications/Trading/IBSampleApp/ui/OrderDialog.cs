...
{
    internal partial  class OrderDialog : Form, IOrderDialog
    {
        ...
        {
            this.Set();
            StaticExtensionIBSample.OrderDialog = this;
            InitializeComponent();
            InitialiseDropDowns();
        ...
        private void InitialiseDropDowns()
        {
            ...
            triggerMethod.Items.AddRange(IBApi.types.TriggerMethod.GetAll());
