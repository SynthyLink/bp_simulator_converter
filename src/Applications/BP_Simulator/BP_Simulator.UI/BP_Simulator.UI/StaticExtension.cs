...
namespace BP_Simulator.UI
{
    ...
    public static class StaticExtension
    {
        ...
        public static FormMain CreateBPForm(string filename, ByteHolder holder,
        ...
        {
            return CreateBPForm(null, filename, holder, addButtons, factories, factory, addReasurces, 
                throwsDoubleInit, caption, icon, logWriter, testInterface);
        }
  
        public static FormMain CreateBPForm(string filename, ButtonWrapper[] addButtons,
        ...
        {
            return CreateBPForm(filename, addButtons, factories, factory, addResources, null, "Business process simulation", logWriter, testInterface);
        }
        ...
        public static FormMain CreateBPForm(string filename, ButtonWrapper[] addButtons,
            ...
            TestCategory.Interfaces.ITestInterface testInterface)
        {
            return CreateBPForm(filename, null, addButtons, factories, factory, addResources, true, caption, icon, 
                logWriter, testInterface);
        }

        public static FormMain CreateBPFormFull(LightDictionary<string, ButtonWrapper[]> buttons, IApplicationInitializer[] init,
        ...
        public static FormMain CreateBPForm(DataWarehouse.Interfaces.IDatabaseCoordinator database, string filename, ByteHolder holder,
            ButtonWrapper[] addButtons, IUIFactory[] factories, Motion6D.Portable.Interfaces.IPositionObjectFactory factory,
