...
class Euler {
	...
	set order(value: 'XYZ' | 'YXZ' | 'ZXY' | 'ZYX' | 'YZX' | 'XZY' ) {
	 ...
	 */
	set(x: number, y: number, z: number, order: 'XYZ' | 'YXZ' | 'ZXY' | 'ZYX' | 'YZX' | 'XZY' = this._order): Euler {
	 ...
	 * @return {Euler} A reference to this Euler instance.
	 */
	setFromRotationMatrix(m: Matrix4, order: 'XYZ' | 'YXZ' | 'ZXY' | 'ZYX' | 'YZX' | 'XZY' = this._order,
		update: boolean = true) {
	 ...
	 * @return {Euler} A reference to this Euler instance.
	 */
	setFromQuaternion(q: Quaternion, order: 'XYZ' | 'YXZ' | 'ZXY' | 'ZYX' | 'YZX' | 'XZY' = 'XYZ', update: boolean = true) {
	 ...
	 * @return {Euler} A reference to this Euler instance.
	 */
	reorder(newOrder: 'XYZ' | 'YXZ' | 'ZXY' | 'ZYX' | 'YZX' | 'XZY'): Euler {
