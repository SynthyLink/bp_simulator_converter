import { Quaternion } from '../../../Library/Vector3D/Quaternion.js';
 ...
 */
function pingpong(x: number, length: number = 1): number {
 ...
 */
function setQuaternionFromProperEuler(q: Quaternion, a: number, b: number, c: number, order: 'XYX' | 'XZX' | 'YXY' | 'YZY' | 'ZXZ' | 'ZYZ') {
 ...
 */
function denormalize(value: number, array: number[]): number {
 ...
 */
function normalize(value: number, array: number[]): number {
