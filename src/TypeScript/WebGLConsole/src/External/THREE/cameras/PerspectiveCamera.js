...
const _v3 = /*@__PURE__*/ new Vector3_1.Vector3();
const _minTarget = /*@__PURE__*/ new Vector2_1.Vector2();
const _maxTarget = /*@__PURE__*/ new Vector2_1.Vector2();
/**
...
class PerspectiveCamera extends Camera_1.Camera {
    ...
    setFocalLength(focalLength) {
        ...
        this.fov = MathUtils_1.RAD2DEG * 2 * Math.atan(vExtentSlope);
        this.updateProjectionMatrix();
    }
    /**
     ...
     */
    getFocalLength() {
        const vExtentSlope = Math.tan(MathUtils_1.DEG2RAD * 0.5 * this.fov);
     ...
     */
    getEffectiveFOV() {
        return MathUtils_1.RAD2DEG * 2 * Math.atan(Math.tan(MathUtils_1.DEG2RAD * 0.5 * this.fov) / this.zoom);
    }
    /**
    ...
    updateProjectionMatrix() {
        ...
        let top = near * Math.tan(MathUtils_1.DEG2RAD * 0.5 * this.fov) / this.zoom;
        let height = 2 * top;
