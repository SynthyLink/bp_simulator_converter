...
class Cessna extends Desktop_1.Desktop {
    ...
    finish() {
        ...
        let t0 = this.mapObjects.get("Cessna_CategoryObject_3");
        if (t0 != undefined)
            arrows[0].setTarget(t0);
        let s1 = this.mapObjects.get("Cessna_CategoryObject_1");
        if (s1 != undefined)
            arrows[1].setSource(s1);
        let t1 = this.mapObjects.get("Cessna_CategoryObject_0_Visible0");
        if (t1 != undefined)
            arrows[1].setTarget(t1);
        let s2 = this.mapObjects.get("Cessna_CategoryObject_5");
        if (s2 != undefined)
            arrows[2].setSource(s2);
        let t2 = this.mapObjects.get("Cessna_CategoryObject_1");
        if (t2 != undefined)
            arrows[2].setTarget(t2);
        let s3 = this.mapObjects.get("Cessna_CategoryObject_5");
        if (s3 != undefined)
            arrows[3].setSource(s3);
        let t3 = this.mapObjects.get("Cessna_CategoryObject_3");
        if (t3 != undefined)
        ...
        let s5 = this.mapObjects.get("Cessna_CategoryObject_5");
        if (s5 != undefined)
            arrows[5].setSource(s5);
        let t5 = this.mapObjects.get("Cessna_CategoryObject_4");
        if (t5 != undefined)
            arrows[5].setTarget(t5);
        let s6 = this.mapObjects.get("Cessna_CategoryObject_5");
        if (s6 != undefined)
            arrows[6].setSource(s6);
        let t6 = this.mapObjects.get("Cessna_CategoryObject_2");
        if (t6 != undefined)
