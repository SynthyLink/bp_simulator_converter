...
class Shuttle_CategoryObject_0 extends Input_1.Input {
...
class Shuttle_CategoryObject_1 extends DifferentialEquationSolverFormula_1.DifferentialEquationSolverFormula {
    constructor(desktop, name) {
        super(desktop, name);
        this.var_0 = 0;
        this.var_1 = 0;
...
class Shuttle_CategoryObject_2 extends VectorFormulaConsumer_1.VectorFormulaConsumer {
    constructor(desktop, name) {
        super(desktop, name);
        this.var_0 = 0;
        this.var_1 = 1;
...
class Shuttle_CategoryObject_3 extends ReferenceFrameData_1.ReferenceFrameData {
    constructor(desktop, name) {
        super(desktop, name);
...
class Shuttle_CategoryObject_4_Visible0 extends Basic3DShape_1.Basic3DShape {
    constructor(desktop, name) {
        super(desktop, name);
...
class Shuttle_CategoryObject_4 extends SerializablePosition_1.SerializablePosition {
    constructor(desktop, name) {
        super(desktop, name);
        this.addChildT(new Shuttle_CategoryObject_4_Visible0(desktop, name));
    }
}
class Shuttle_CategoryObject_5 extends BasicCamera_1.BasicCamera {
    constructor(desktop, name) {
        super(desktop, name);
        this.fieldOfView = 30;
        this.nearDistance = 1;
...
class Shuttle_CategoryObject_6 extends TimerObject_1.TimerObject {
    constructor(desktop, name) {
        super(desktop, name);
        this.span = TimeSpan_1.TimeSpan.fromMilliseconds(100);
    }
}
class Shuttle_CategoryObject_7 extends RigidReferenceFrame_1.RigidReferenceFrame {
    constructor(desktop, name) {
        super(desktop, name);
...
class Shuttle_CategoryObject_8 extends VectorFormulaConsumer_1.VectorFormulaConsumer {
    constructor(desktop, name) {
        super(desktop, name);
        this.var_0 = 0;
        let map = new Map([]);
...
class Shuttle_CategoryObject_9 extends DataConsumer_1.DataConsumer {
    constructor(desktop, name) {
        super(desktop, name);
    }
}
class Shuttle_CategoryObject_10 extends RigidReferenceFrame_1.RigidReferenceFrame {
    constructor(desktop, name) {
        super(desktop, name);
        this.relativePosition = [];
        this.relativeQuaternion = [];
...
class Shuttle_CategoryArrow_0 extends DataLink_1.DataLink {
    constructor(desktop, name) {
        super(desktop, name);
    }
}
class Shuttle_CategoryArrow_1 extends DataLink_1.DataLink {
    constructor(desktop, name) {
        super(desktop, name);
    }
}
class Shuttle_CategoryArrow_2 extends DataLink_1.DataLink {
    constructor(desktop, name) {
        super(desktop, name);
    }
}
class Shuttle_CategoryArrow_3 extends ReferenceFrameArrow_1.ReferenceFrameArrow {
    constructor(desktop, name) {
        super(desktop, name);
    }
}
class Shuttle_CategoryArrow_4 extends VisibleConsumerLink_1.VisibleConsumerLink {
    constructor(desktop, name) {
        super(desktop, name);
    }
}
class Shuttle_CategoryArrow_5 extends BelognsToCollection_1.BelongsToCollection {
    constructor(desktop, name) {
        super(desktop, name);
    }
}
class Shuttle_CategoryArrow_6 extends BelognsToCollection_1.BelongsToCollection {
    constructor(desktop, name) {
        super(desktop, name);
    }
}
class Shuttle_CategoryArrow_7 extends BelognsToCollection_1.BelongsToCollection {
    constructor(desktop, name) {
        super(desktop, name);
    }
}
class Shuttle_CategoryArrow_8 extends DataLink_1.DataLink {
    constructor(desktop, name) {
        super(desktop, name);
    }
}
class Shuttle_CategoryArrow_9 extends EventLink_1.EventLink {
    constructor(desktop, name) {
        super(desktop, name);
    }
}
class Shuttle_CategoryArrow_10 extends EventLink_1.EventLink {
    constructor(desktop, name) {
        super(desktop, name);
    }
}
class Shuttle_CategoryArrow_11 extends DataLink_1.DataLink {
    constructor(desktop, name) {
        super(desktop, name);
    }
}
class Shuttle_CategoryArrow_12 extends DataLink_1.DataLink {
    constructor(desktop, name) {
        super(desktop, name);
    }
}
class Shuttle_CategoryArrow_13 extends ReferenceFrameArrow_1.ReferenceFrameArrow {
    constructor(desktop, name) {
        super(desktop, name);
    }
}
class Shuttle_CategoryArrow_14 extends ReferenceFrameArrow_1.ReferenceFrameArrow {
    constructor(desktop, name) {
        super(desktop, name);
    }
}
class Shuttle extends Desktop_1.Desktop {
    constructor() {
        super();
        this.name = "Shuttle";
