...
exports.XToonExample = exports.XToonRenderer = void 0;
...
class XToonRenderer extends webgl_operate_2.Renderer {
    _loader;
    _navigation;
    _forwardPass;
    _camera;
    ...
    onInitialize(context, callback, eventProvider) {
        ...
        const vert = new webgl_operate_2.Shader(context, gl.VERTEX_SHADER, 'xtoon.vert');
        vert.initialize(require('./data/xtoon.vert'));
        const frag = new webgl_operate_2.Shader(context, gl.FRAGMENT_SHADER, 'xtoon.frag');
...
exports.XToonRenderer = XToonRenderer;
class XToonExample extends example_1.Example {
    _canvas;
    _renderer;
...
exports.XToonExample = XToonExample;
//# sourceMappingURL=xtoon-example.js.map