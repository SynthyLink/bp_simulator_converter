...
import { BlitPass, Canvas, Context, NdcFillingTriangle, DefaultFramebuffer, EventProvider, Framebuffer, Invalidate, Program, Renderer, Texture2D } from 'webgl-operate';
import { Example } from './example';
export declare class DfdxDfdyRenderer extends Renderer {
...
export declare class DfdxDfdyExample extends Example {
    private _canvas;
    private _renderer;
...
//# sourceMappingURL=dfdx-dfdy-example.d.ts.map