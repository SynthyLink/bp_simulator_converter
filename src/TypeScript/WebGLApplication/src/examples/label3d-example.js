...
brown belly, slightly domed and divided by arches into stiff sections.';
        this._labelWrap = new webgl_operate_2.Position3DLabel(new webgl_operate_2.Text(`Wrap: ${kafka}`), webgl_operate_2.Label.Type.Dynamic);
        this._labelWrap.wrap = true;
        this._labelWrap.lineWidth = 0.8;
        this._labelCentered = new webgl_operate_2.Position3DLabel(new webgl_operate_2.Text(`Label.LineAnchor\n+\nLabel.Alignment.Center`), webgl_operate_2.Label.Type.Dynamic);
        this._labelCentered.lineAnchor = webgl_operate_2.Label.LineAnchor.Center;
        this._labelCentered.alignment = webgl_operate_2.Label.Alignment.Center;
...
class Label3DExample extends example_1.Example {
    _canvas;
    _renderer;
...
exports.Label3DExample = Label3DExample;
