...
exports.ImageBasedLightingExample = exports.ImageBasedLightingRenderer = void 0;
const gl_matrix_1 = require("gl-matrix");
const webgl_operate_1 = require("webgl-operate");
const example_1 = require("./example");
/* spellchecker: enable */
// tslint:disable:max-classes-per-file
class ImageBasedLightingRenderer extends webgl_operate_1.Renderer {
    _camera;
    _navigation;
    ...
    onInitialize(context, callback, eventProvider) {
        ...
        const gl = context.gl;
        this._sphere = new webgl_operate_1.GeosphereGeometry(context, 'Sphere');
        ...
        const frag = new webgl_operate_1.Shader(context, gl.FRAGMENT_SHADER, 'imagebasedlighting.frag');
        ...
        this._promises.push(this._albedoTexture.fetch('/examples/data/imagebasedlighting/Metal_001_basecolor.png'));
        ...
        this._promises.push(this._roughnessTexture.fetch('/examples/data/imagebasedlighting/Metal_001_roughness.png'));
        ...
        this._promises.push(this._metallicTexture.fetch('/examples/data/imagebasedlighting/Metal_001_metallic.png'));
        ...
        this._promises.push(this._normalTexture.fetch('/examples/data/imagebasedlighting/Metal_001_normal.png'));
        this._brdfLUT = new webgl_operate_1.Texture2D(context, 'BRDFLookUpTable');
        ...
        this._promises.push(this._brdfLUT.fetch('/examples/data/imagebasedlighting/brdfLUT.png'));
        const internalFormatAndType = webgl_operate_1.Wizard.queryInternalTextureFormat(this._context, gl.RGBA, webgl_operate_1.Wizard.Precision.byte);
        this._cubemap = new webgl_operate_1.TextureCube(context, 'Cubemap');
        ...
        this._environmentRenderingPass = new webgl_operate_1.EnvironmentRenderingPass(context);
...
exports.ImageBasedLightingRenderer = ImageBasedLightingRenderer;
class ImageBasedLightingExample extends example_1.Example {
    _canvas;
    _renderer;
...
exports.ImageBasedLightingExample = ImageBasedLightingExample;
//# sourceMappingURL=imagebasedlighting-example.js.map