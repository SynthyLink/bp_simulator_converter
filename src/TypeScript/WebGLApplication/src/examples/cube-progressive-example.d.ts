...
import { AccumulatePass, AntiAliasingKernel, BlitPass, Camera, Canvas, Context, CuboidGeometry, DefaultFramebuffer, EventProvider, Framebuffer, Invalidate, Navigation, Program, Renderbuffer, Renderer, Texture2D } from 'webgl-operate';
import { Example } from './example';
export declare class ProgressiveCubeRenderer extends Renderer {
...
export declare class ProgressiveCubeExample extends Example {
    private _canvas;
    private _renderer;
...
//# sourceMappingURL=cube-progressive-example.d.ts.map