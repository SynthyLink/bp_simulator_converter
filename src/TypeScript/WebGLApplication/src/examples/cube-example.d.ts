import { Camera, Canvas, Context, CuboidGeometry, DefaultFramebuffer, EventProvider, Invalidate, Navigation, Program, Renderer, Texture2D } from 'webgl-operate';
import { Example } from './example';
export declare class CubeRenderer extends Renderer {
...
export declare class CubeExample extends Example {
    private _canvas;
    private _renderer;
...
//# sourceMappingURL=cube-example.d.ts.map