import { Camera, Canvas, Context, EventProvider, Framebuffer, GLTFLoader, GLTFPrimitive, Invalidate, Navigation, Program, Renderer, Texture2D } from 'webgl-operate';
import { Example } from './example';
export declare class InstancedRenderer extends Renderer {
...
export declare class InstancedRenderingExample extends Example {
    private _canvas;
    private _renderer;
...
//# sourceMappingURL=instanced-rendering-example.d.ts.map