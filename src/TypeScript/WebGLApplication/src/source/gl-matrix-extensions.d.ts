...
declare namespace gl_matrix_extensions {
    /**
     ...
     */
    function clamp2(out: vec2, x: vec2 | number[], min: vec2 | number[], max: vec2 | number[]): vec2;
    /**
     ...
     */
    function abs2(out: vec2, x: vec2): vec2;
    /**
     ...
     * @returns - Vector constrained to [min,max].
     */
    function clamp3(out: vec3, x: vec3 | number[], min: vec3 | number[], max: vec3 | number[]): vec3;
    /**
     ...
     * @returns  - Vector with each component as absolute value.
     */
    function abs3(out: vec3, x: vec3): vec3;
    /**
     ...
     */
    function decode_float24x1_from_uint8x3(x: vec3): number;
    /**
     ...
     */
    function encode_uint24_to_rgb8(out: vec3, x: number): vec3;
    /**
     ...
     * @returns - Three component byte vector with x packed.
     */
    function encode_uint32_to_rgba8(out: vec4, x: number): vec4;
    /**
     ...
     */
    function decode_uint24_from_rgb8(x: vec3): number;
    /**
     ...
     */
    function decode_uint32_from_rgba8(x: vec4): number;
    /**
     ...
     * @returns - Vector constrained to [min,max].
     */
    function clamp4(out: vec4, x: vec4 | number[], min: vec4 | number[], max: vec4 | number[]): vec4;
    /**
     ...
     * @returns - Vector with each component as absolute value.
     */
    function abs4(out: vec4, x: vec4): vec4;
    /**
     ...
     */
    function parseVec2(v2str: string | undefined): vec2 | undefined;
    /**
     ...
     */
    function parseVec3(v3str: string | undefined): vec3 | undefined;
    /**
     ...
     */
    function parseVec4(v4str: string | undefined): vec4 | undefined;
    /**
     ...
     */
    function mix(value1: number, value2: number, interpolation: number): number;
    /**
