 ...
 * ```
 */
export declare class AllocationRegister {
    /**
     * Map that provides access to the accumulated memory allocations for all registered identifiers.
     */
    protected _bytesByIdentifier: Map<string, number>;
    /** @see {@link bytes} */
    protected _bytes: GLsizei;
    protected _bytesSubject: ReplaySubject<[number, string]>;
    /**
...
//# sourceMappingURL=allocationregister.d.ts.map