...
export declare class CuboidGeometry extends Geometry {
    ...
    protected static readonly VERTICES_UV: Float32Array<ArrayBuffer>;
    protected static readonly INDICES_UV: Uint8Array<ArrayBuffer>;
...
//# sourceMappingURL=cuboidgeometry.d.ts.map