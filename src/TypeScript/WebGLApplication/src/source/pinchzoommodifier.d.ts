...
export declare class PinchZoomModifier extends CameraModifier {
    protected static readonly DEFAULT_SENSITIVITY = 2;
...
//# sourceMappingURL=pinchzoommodifier.d.ts.map