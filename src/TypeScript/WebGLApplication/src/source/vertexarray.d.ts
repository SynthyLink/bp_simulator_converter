 ...
 * ```
 */
export declare class VertexArray extends AbstractObject<any> implements Bindable {
    /**
     ...
     */
    protected _buffersBound: boolean;
    /**
     ...
     */
    protected create(bindBOs: () => void, unbindBOs: () => void): any | undefined;
    /**
