...
class ChangeLookup {
     ...
     */
    static alter(path, property) {
        // eslint-disable-next-line no-prototype-builtins
        (0, auxiliaries_1.assert)(property.hasOwnProperty('any'), `expected alterable object to provide 'any' key`);
        property.any = true;
        const names = path.split('.');
        const name = names.shift();
        // eslint-disable-next-line no-prototype-builtins
        (0, auxiliaries_1.assert)(name === '' || property.hasOwnProperty(name), `expected object to have key '${name}' in order to capture alterations`);
...
//# sourceMappingURL=changelookup.js.map