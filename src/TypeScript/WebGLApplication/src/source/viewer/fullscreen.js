...
(function (viewer) {
    ...
    class Fullscreen {
        ...
        static queryAndCacheAPI() {
            ...
            switch (api) {
                case 0: // native
                    ...
                    Fullscreen._request = (element) => element.requestFullscreen();
                ...
                case 1: // microsoft
                    ...
                    Fullscreen._request = (element) => element.msRequestFullscreen();
                ...
                case 2: // mozilla
                    ...
                    Fullscreen._request = (element) => element.mozRequestFullScreen();
                ...
                case 3: // webkit
                    ...
                    Fullscreen._request = (element) => element.webkitRequestFullscreen();
                    Fullscreen._element = () => document.webkitFullscreenElement;
                    Fullscreen._event = 'webkitfullscreenchange';
                    break;
                default:
                    (0, auxiliaries_1.assert)(false, `none of the following fullscreen apis was found: native, ms, moz, or webkit`);
            }
        }
        /**
         ...
         */
        static toggle(element, callback) {
