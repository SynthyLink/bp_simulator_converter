...
exports.RandomSquareKernel = void 0;
 ...
 * ```
 */
class RandomSquareKernel extends kernel_1.KernelF32 {
    /**
     ...
     */
    generate() {
        (0, auxiliaries_1.assert)(this.width > 0, `expected every kernel to comprise at least one element`);
        this.set([0.0, 0.0], 0);
        for (let i = 1; i < this.width; ++i) {
            this.set([(0, auxiliaries_1.rand)(-0.5, +0.5), (0, auxiliaries_1.rand)(-0.5, +0.5)], i);
        }
    }
    /**
     * @override
...
//# sourceMappingURL=randomsquarekernel.js.map