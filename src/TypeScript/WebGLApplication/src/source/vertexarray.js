 ...
 * ```
 */
class VertexArray extends object_1.AbstractObject {
    /**
     * Default vertex array, e.g., used for unbind.
     */
    static DEFAULT_VERTEX_ARRAY = undefined;
    /**
    ...
    delete() {
        ...
        (0, auxiliaries_1.assert)(this._object !== undefined, `expected WebGLVertexArrayObject object`);
