import { GLclampf2, GLfloat2 } from '../tuples';
/**
...
export declare class Glyph {
    ...
    /** @see {@link bearing} */
    protected _bearing: GLfloat2;
    /** @see {@link extent} */
    protected _extent: GLfloat2;
    /** @see {@link index} */
    protected _index: GLsizei;
    /** @see {@link kernings} */
    protected _kernings: Map<number, number>;
    /** @see {@link subTextureOrigin} */
    protected _subTextureOrigin: GLclampf2;
    /** @see {@link subTextureExtent} */
    protected _subTextureExtent: GLclampf2;
    constructor(index?: GLsizei, advance?: GLfloat);
    /**
