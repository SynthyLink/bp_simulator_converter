 ...
 */
class GlyphVertices {
    static FLOATS_PER_TEXCOORD = 4;
    static FLOATS_PER_ORIGIN = 3;
    static FLOATS_PER_TANGENT = 3;
    static FLOATS_PER_UP = 3;
    /** @see {@link origins} */
    _origins;
    /** @see {@link tangents} */
    _tangents;
    ...
    shrink(numberOfGlyphs) {
        ...
        const shrink = (array, length, components) => array = new Float32Array(array.buffer.slice(0, length * array.BYTES_PER_ELEMENT * components), 0, length * components);
...
//# sourceMappingURL=glyphvertices.js.map