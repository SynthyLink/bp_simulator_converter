...
describe('Color', () => {
    ...
    it('should scale and round unsigned int (8bit) values', () => {
        let color = new color_1.Color([0.1, 0.2, 0.3]);
        expect(Array.from(color.rgbUI8)).to.deep.equal([26, 51, 77]);
        color = new color_1.Color([0.1, 0.2, 0.3, 0.4]);
    ...
    it('should provide RGBA component getter', () => {
        const color = new color_1.Color([0.1, 0.2, 0.3, 0.4]);
    ...
    it('should log and default on malformed hex color string to RGB(A) conversion', () => {
        ...
        const malformed = ['#', '0x', '', '#0', '0x0', '0', '#00', '0x00', '00', '#00000', '0x00000',
    ...
    it('should compute various grayscales', () => {
        ...
        expect(color.gray(color_1.Color.GrayscaleAlgorithm.Average)).to.be.closeTo(0.4392, 1e-4);
        expect(color.gray(color_1.Color.GrayscaleAlgorithm.LeastSaturatedVariant)).to.be.closeTo(0.2824, 1e-4);
        expect(color.gray(color_1.Color.GrayscaleAlgorithm.LinearLuminance)).to.be.closeTo(0.3636, 1e-4);
        expect(color.gray(color_1.Color.GrayscaleAlgorithm.MaximumDecomposition)).to.be.closeTo(0.7529, 1e-4);
        expect(color.gray(color_1.Color.GrayscaleAlgorithm.MinimumDecomposition)).to.be.closeTo(0.1882, 1e-4);
    ...
    it('should support check for equality', () => {
        const color0 = new color_1.Color();
        color0.fromUI8(48, 96, 192);
        const color1 = new color_1.Color();
    ...
    it('should mix two colors in supported color spaces', () => {
        ...
        let color2;
        expect(color_1.Color.lerp(color0, color1, 0.0, color_1.Color.Space.RGB).equals(color0)).to.be.true;
        expect(color_1.Color.lerp(color0, color1, 1.0, color_1.Color.Space.RGB).equals(color1)).to.be.true;
        color2 = color_1.Color.lerp(color0, color1, 0.2, color_1.Color.Space.RGB);
        expect(Array.from(color2.rgbaUI8)).to.have.ordered.members([12, 24, 48, 96]);
        expect(color_1.Color.lerp(color0, color1, 0.0, color_1.Color.Space.LAB).equals(color0)).to.be.true;
        expect(color_1.Color.lerp(color0, color1, 1.0, color_1.Color.Space.LAB).equals(color1)).to.be.true;
        color2 = color_1.Color.lerp(color0, color1, 0.4, color_1.Color.Space.LAB);
        expect(Array.from(color2.rgbaUI8)).to.have.ordered.members([16, 29, 55, 112]);
        expect(color_1.Color.lerp(color0, color1, 0.0).equals(color0)).to.be.true;
        expect(color_1.Color.lerp(color0, color1, 1.0).equals(color1)).to.be.true;
        color2 = color_1.Color.lerp(color0, color1, 0.4);
        expect(Array.from(color2.rgbaUI8)).to.have.ordered.members([16, 29, 55, 112]);
        expect(color_1.Color.lerp(color0, color1, 0.0, color_1.Color.Space.HSL).equals(color0)).to.be.true;
        expect(color_1.Color.lerp(color0, color1, 1.0, color_1.Color.Space.HSL).equals(color1)).to.be.true;
        color2 = color_1.Color.lerp(color0, color1, 0.6, color_1.Color.Space.HSL);
        expect(Array.from(color2.rgbaUI8)).to.have.ordered.members([16, 32, 64, 128]);
        expect(color_1.Color.lerp(color0, color1, 0.0, color_1.Color.Space.CMYK).equals(color0)).to.be.true;
        expect(color_1.Color.lerp(color0, color1, 1.0, color_1.Color.Space.CMYK).equals(color1)).to.be.true;
        color2 = color_1.Color.lerp(color0, color1, 0.8, color_1.Color.Space.CMYK);
    ...
    it('should support tuple conversion for supported color spaces', () => {
        const color = new color_1.Color();
        const cmyk = color.fromUI8(138, 122, 107).tuple(color_1.Color.Space.CMYK, false);
        ...
        const cmyka = color.fromUI8(134, 116, 39).tuple(color_1.Color.Space.CMYK);
        expect(cmyka.length).to.be.equal(5);
        expect(cmyka[4]).to.be.equal(1.0);
        const hsl = color.fromUI8(48, 56, 64).tuple(color_1.Color.Space.HSL, false);
        ...
        const hsla = color.fromUI8(134, 116, 39).tuple(color_1.Color.Space.HSL);
        expect(hsla.length).to.be.equal(4);
        expect(hsla[3]).to.be.equal(1.0);
        const lab = color.fromUI8(100, 116, 39).tuple(color_1.Color.Space.LAB, false);
        ...
        const laba = color.fromUI8(100, 116, 39).tuple(color_1.Color.Space.LAB);
        expect(laba.length).to.be.equal(4);
        expect(laba[3]).to.be.equal(1.0);
        const rgb = color.fromUI8(26, 51, 77).tuple(color_1.Color.Space.RGB, false);
        ...
        const rgba = color.fromUI8(134, 116, 39).tuple(color_1.Color.Space.RGB);
