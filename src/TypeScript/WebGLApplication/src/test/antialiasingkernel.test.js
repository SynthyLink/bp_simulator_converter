...
const antialiasingkernel_1 = require("../source/antialiasingkernel");
/* spellchecker: enable */
describe('AntiAliasingKernel', () => {
    it('should comprise at least a single element', () => {
        const kernel = new antialiasingkernel_1.AntiAliasingKernel(0);
        expect(kernel.elements).to.be.equal(1);
    });
    it('should have two component samples and provide byte information', () => {
        const kernel = new antialiasingkernel_1.AntiAliasingKernel(4);
    ...
    it('should start with [0.0, 0.0] unless golden set', () => {
        const kernel = new antialiasingkernel_1.AntiAliasingKernel(1);
...
//# sourceMappingURL=antialiasingkernel.test.js.map