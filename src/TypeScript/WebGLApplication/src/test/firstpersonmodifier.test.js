...
const firstpersonmodifier_1 = require("../source/firstpersonmodifier");
/* spellchecker: enable */
describe('first person modifier', () => {
    let firstPersonModifier;
    let originalCamera;
    let firstPersonModifierCamera;
    beforeEach(() => {
        firstPersonModifier = new firstpersonmodifier_1.FirstPersonModifier();
        originalCamera = new camera_1.Camera();
        firstPersonModifierCamera = new camera_1.Camera();
...
//# sourceMappingURL=firstpersonmodifier.test.js.map