...
export class OrbitalForecastCalculation extends OrbitalForecast implements IAction, IFunc<boolean> {
    ...
    getOrbitalInitial(): OrbitalForecastConditionNumber {
        var dt = new Date();
        var b = this.converter.toOADate(dt) * 86400;
        var e = b + 20000;

        return {
            begin: b, end: e, x: -5448.34815324, y: -4463.9368421, z: 0, vx: -0.985394777432, vy: 1.21681893834, vz: 7.45047785592
        }
    }
