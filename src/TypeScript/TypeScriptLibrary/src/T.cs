...
{
	public  class T : Diagram.UI.PureDesktop
	{
		public T()
		{
			objects.Add(new T.OblectLabel0("X", this));
			objects.Add(new T.OblectLabel1("Y", this));
			objects.Add(new T.OblectLabel2("Data", this));
			objects.Add(new T.OblectLabel3("Recursive", this));
			objects.Add(new T.OblectLabel4("Chart", this));
			Diagram.UI.Labels.PureArrowLabel currALabel = null;
			currALabel  = new T.ArrowLabel0("2", this);
			arrows.Add(currALabel);
			currALabel.SourceNumber = (int)2;
			currALabel.TargetNumber = (int)1;
			currALabel  = new T.ArrowLabel1("1", this);
			arrows.Add(currALabel);
			currALabel.SourceNumber = (int)2;
			currALabel.TargetNumber = (int)0;
			currALabel  = new T.ArrowLabel2("3", this);
			arrows.Add(currALabel);
			currALabel.SourceNumber = (int)3;
			currALabel.TargetNumber = (int)2;
			currALabel  = new T.ArrowLabel3("4", this);
			arrows.Add(currALabel);
