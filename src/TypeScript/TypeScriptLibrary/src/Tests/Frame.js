...
class Frame_CategoryObject_1 extends VectorFormulaConsumer_1.VectorFormulaConsumer {
    ...
    save() {
        var v = this.variables;
        var x0 = v.get("Formula_1");
        x0 === null || x0 === void 0 ? void 0 : x0.setIValue(this.get_57());
        var x1 = v.get("Formula_2");
        x1 === null || x1 === void 0 ? void 0 : x1.setIValue(this.get_102());
        var x2 = v.get("Formula_3");
        x2 === null || x2 === void 0 ? void 0 : x2.setIValue(this.get_103());
        var x3 = v.get("Formula_4");
        x3 === null || x3 === void 0 ? void 0 : x3.setIValue(this.get_114());
        var x4 = v.get("Formula_5");
        x4 === null || x4 === void 0 ? void 0 : x4.setIValue(this.get_115());
        var x5 = v.get("Formula_6");
        x5 === null || x5 === void 0 ? void 0 : x5.setIValue(this.get_127());
        var x6 = v.get("Formula_7");
        x6 === null || x6 === void 0 ? void 0 : x6.setIValue(this.get_140());
    }
}
