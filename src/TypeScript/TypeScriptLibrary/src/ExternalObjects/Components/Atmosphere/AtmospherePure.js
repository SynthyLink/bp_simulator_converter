...
class AtmospherePure {
    ...
    mac = [31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334, 365];
    f01 = [-14.608, 0.8969, 67.596, -0.4016, 0.3031E-2, 0.2344E-5, 0.130,
    ...
    KDNEY = [31, 0, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31];
    N10 = 0;
    f1 = [];
    ifa = [150, 6, 140];
    if1 = [75, 100, 125, 150, 200, 250];
    date = [0, 0, 0];
    r = [0, 0, 0];
    y = [0, 0, 0];
    ff0 = [];
