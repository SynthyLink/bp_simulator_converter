...
namespace GeneratedProject
{
	public  class Random : Diagram.UI.PureDesktop
	{
		public Random()
		{
			objects.Add(new Random.OblectLabel0("X", this));
			objects.Add(new Random.OblectLabel1("Y", this));
			objects.Add(new Random.OblectLabel2("Data", this));
