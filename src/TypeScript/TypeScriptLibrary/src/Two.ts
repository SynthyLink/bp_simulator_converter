...
class Two_CategoryObject_0 extends VectorFormulaConsumer
{
	constructor(desktop: IDesktop, name: string)
	{
		...
		this.addVariable(this.pMeasurements.createVariable("Formula_2", 0, 0, this));
	}
...
class Two_CategoryObject_1 extends VectorFormulaConsumer
{
	constructor(desktop: IDesktop, name: string)
	{
		super(desktop, name);
		...
		this.addVariable(this.pMeasurements.createVariable("Formula_1", 0, 0, this));
		this.addVariable(this.pMeasurements.createVariable("Formula_2", 0, 0, this));
		this.addVariable(this.pMeasurements.createVariable("Formula_3", 0, 0, this));
	}
...
class Two_CategoryArrow_0 extends DataLink
{
	constructor(desktop: IDesktop, name: string)
	{
		super(desktop, name);
...
export class Two extends Desktop
{
	constructor()
	{
		super();
