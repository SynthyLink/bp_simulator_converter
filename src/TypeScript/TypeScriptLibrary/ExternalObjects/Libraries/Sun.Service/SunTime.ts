export class SunTime {
    ...
    public  CalculateJulianCentury(julianDate: number): number
    {
    ...
    public CalculateGreenwichSiderealTime(julianCentury : number) : number{
