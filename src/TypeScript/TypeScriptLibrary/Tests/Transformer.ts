...
class Transformer_CategoryObject_0 extends VectorFormulaConsumer
{
...
class Transformer_CategoryObject_2 extends DataConsumer
{
	constructor(desktop: IDesktop, name: string)
	{
		super(desktop, name);
...
class Transformer_CategoryArrow_0 extends DataLink
{
	constructor(desktop: IDesktop, name: string)
	{
		super(desktop, name);
...
class Transformer_CategoryArrow_1 extends DataLink
{
	constructor(desktop: IDesktop, name: string)
	{
		super(desktop, name);
...
export class Transformer extends Desktop
{
	constructor()
	{
		super();
