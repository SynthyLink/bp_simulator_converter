...
class ODE_Feedback_CategoryObject_0 extends VectorFormulaConsumer
{
	...
	aliasName7 : IAliasName =  new FictiveAliasName();
	aliasName8 : IAliasName =  new FictiveAliasName();
	var_0 : number  = 0;
	var_1 : number  = 0;
	var_2 : number  = 0;
	var_3 : number  = 0;
...
class ODE_Feedback_CategoryObject_1 extends DifferentrialEquationSolverFormula
{
	constructor(desktop: IDesktop, name: string)
	{
		super(desktop, name);
