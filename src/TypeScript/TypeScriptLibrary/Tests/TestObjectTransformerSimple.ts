...
class TestObjectTransformerSimple_CategoryObject_1 extends DifferentrialEquationSolverFormula
{
	constructor(desktop: IDesktop, name: string)
	{
		super(desktop, name);
...
export class TestObjectTransformerSimple extends Desktop
{
	constructor()
	{
		...
		new TestObjectTransformerSimple_CategoryObject_0(this, "Init");
		new TestObjectTransformerSimple_CategoryObject_1(this, "ODE");
