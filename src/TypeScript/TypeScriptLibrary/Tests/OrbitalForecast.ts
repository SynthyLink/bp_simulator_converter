import { AtmosphereCategoryObject } from "../ExternalObjects/Atmosphere/AtmosphereCategoryObject";
import { GravityCategoryObject } from "../ExternalObjects/Gravity_36_36/GravityCategoryObject";
...
class OrbitalForecast_CategoryObject_2 extends VectorFormulaConsumer
{
	...
	aliasName5 : IAliasName =  new FictiveAliasName();
	aliasName6 : IAliasName =  new FictiveAliasName();
	aliasName9 : IAliasName =  new FictiveAliasName();
	aliasName13 : IAliasName =  new FictiveAliasName();
	var_0 : number  = 0;
	var_1 : number  = 0;
	var_2 : number  = 0;
	var_3 : number  = 0;
...
class OrbitalForecast_CategoryObject_5 extends DifferentialEquationSolverFormula
{
	...
	measurement7 : IMeasurement = new FictiveMeasurement();
	value9 : IValue = new FictiveValue();
	value14 : IValue = new FictiveValue();
	measurement17 : IMeasurement = new FictiveMeasurement();
	value18 : IValue = new FictiveValue();
	measurement27 : IMeasurement = new FictiveMeasurement();
	value30 : IValue = new FictiveValue();
	aliasName1 : IAliasName =  new FictiveAliasName();
	aliasName4 : IAliasName =  new FictiveAliasName();
	aliasName13 : IAliasName =  new FictiveAliasName();
	var_0 : number  = 0;
...
class OrbitalForecast_CategoryObject_6 extends RecursiveFormula
{
	...
	measurement0 : IMeasurement = new FictiveMeasurement();
	value3 : IValue = new FictiveValue();
	var_0 : number  = 0;
	var_1 : number  = 0;
	var_2 : boolean  = false;
	var_3 : number  = 0;
