...
{
	public  class RandomGenerator : Diagram.UI.PureDesktop
	{
		public RandomGenerator()
		{
			objects.Add(new RandomGenerator.OblectLabel0("X", this));
			objects.Add(new RandomGenerator.OblectLabel1("Y", this));
			objects.Add(new RandomGenerator.OblectLabel2("Data", this));
			objects.Add(new RandomGenerator.OblectLabel3("Recursive", this));
			objects.Add(new RandomGenerator.OblectLabel4("Chart", this));
			Diagram.UI.Labels.PureArrowLabel currALabel = null;
			currALabel  = new RandomGenerator.ArrowLabel0("2", this);
			arrows.Add(currALabel);
			currALabel.SourceNumber = (int)2;
			currALabel.TargetNumber = (int)1;
			currALabel  = new RandomGenerator.ArrowLabel1("1", this);
			arrows.Add(currALabel);
			currALabel.SourceNumber = (int)2;
			currALabel.TargetNumber = (int)0;
			currALabel  = new RandomGenerator.ArrowLabel2("3", this);
			arrows.Add(currALabel);
			currALabel.SourceNumber = (int)3;
			currALabel.TargetNumber = (int)2;
			currALabel  = new RandomGenerator.ArrowLabel3("4", this);
			arrows.Add(currALabel);
