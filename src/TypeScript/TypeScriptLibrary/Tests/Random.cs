...
{
	public  class Random : Diagram.UI.PureDesktop
	{
		public Random()
		{
			objects.Add(new Random.OblectLabel0("Vector", this));
			objects.Add(new Random.OblectLabel1("Source", this));
			objects.Add(new Random.OblectLabel2("Transformer", this));
			objects.Add(new Random.OblectLabel3("Recursive", this));
			objects.Add(new Random.OblectLabel4("Chart", this));
			Diagram.UI.Labels.PureArrowLabel currALabel = null;
			currALabel  = new Random.ArrowLabel0("", this);
			arrows.Add(currALabel);
			currALabel.SourceNumber = (int)2;
			currALabel.TargetNumber = (int)1;
			currALabel  = new Random.ArrowLabel1("", this);
			arrows.Add(currALabel);
			currALabel.SourceNumber = (int)2;
			currALabel.TargetNumber = (int)0;
			currALabel  = new Random.ArrowLabel2("", this);
			arrows.Add(currALabel);
			currALabel.SourceNumber = (int)3;
			currALabel.TargetNumber = (int)2;
			currALabel  = new Random.ArrowLabel3("", this);
			arrows.Add(currALabel);
			currALabel.SourceNumber = (int)3;
			currALabel.TargetNumber = (int)0;
			currALabel  = new Random.ArrowLabel4("", this);
			arrows.Add(currALabel);
			currALabel.SourceNumber = (int)4;
			currALabel.TargetNumber = (int)3;
			currALabel  = new Random.ArrowLabel5("", this);
			arrows.Add(currALabel);
			currALabel.SourceNumber = (int)4;
			currALabel.TargetNumber = (int)2;
			bool pl = PostLoad();
		...
		internal class OblectLabel0 : Diagram.UI.Labels.PureObjectLabel
		{
			...
			internal class CategoryObject : DataPerformer.Formula.VectorFormulaConsumer, FormulaEditor.Interfaces.ITreeCollectionProxyFactory
			{
				...
				internal CategoryObject()
				{
					...
					{
						{"a", (double)0.19288702860157331 },
						{"c", (double)0.52807755063743145 },
						{"d", (double)9 },
						{"b", (double)0.0021040127652205607 }
					};
