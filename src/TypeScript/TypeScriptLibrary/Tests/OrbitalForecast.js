...
const AtmosphereCategoryObject_1 = require("../ExternalObjects/Atmosphere/AtmosphereCategoryObject");
const GravityCategoryObject_1 = require("../ExternalObjects/Gravity_36_36/GravityCategoryObject");
...
class OrbitalForecast_CategoryObject_2 extends VectorFormulaConsumer_1.VectorFormulaConsumer {
    constructor(desktop, name) {
        ...
        this.aliasName5 = new FictiveAliasName_1.FictiveAliasName();
        this.aliasName6 = new FictiveAliasName_1.FictiveAliasName();
        this.aliasName9 = new FictiveAliasName_1.FictiveAliasName();
        this.aliasName13 = new FictiveAliasName_1.FictiveAliasName();
        this.var_0 = 0;
        this.var_1 = 0;
        this.var_2 = 0;
        this.var_3 = 0;
...
class OrbitalForecast_CategoryObject_5 extends DifferentialEquationSolverFormula_1.DifferentialEquationSolverFormula {
    constructor(desktop, name) {
        ...
        this.measurement7 = new FictiveMeasurement_1.FictiveMeasurement();
        this.value9 = new FictiveValue_1.FictiveValue();
        this.value14 = new FictiveValue_1.FictiveValue();
        this.measurement17 = new FictiveMeasurement_1.FictiveMeasurement();
        this.value18 = new FictiveValue_1.FictiveValue();
        this.measurement27 = new FictiveMeasurement_1.FictiveMeasurement();
        this.value30 = new FictiveValue_1.FictiveValue();
        this.aliasName1 = new FictiveAliasName_1.FictiveAliasName();
        this.aliasName4 = new FictiveAliasName_1.FictiveAliasName();
        this.aliasName13 = new FictiveAliasName_1.FictiveAliasName();
        this.var_0 = 0;
...
class OrbitalForecast_CategoryObject_6 extends RecursiveFormula_1.RecursiveFormula {
    constructor(desktop, name) {
        super(desktop, name);
        this.measurement0 = new FictiveMeasurement_1.FictiveMeasurement();
        this.value3 = new FictiveValue_1.FictiveValue();
        this.var_0 = 0;
        this.var_1 = 0;
        this.var_2 = false;
        this.var_3 = 0;
