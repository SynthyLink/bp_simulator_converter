...
class Cessna_CategoryObject_3 extends BasicCamera
{
	constructor(desktop: IDesktop, name: string)
	{
		super(desktop, name);
...
class Cessna_CategoryObject_4 extends TimerObject
{
	constructor(desktop: IDesktop, name: string)
	{
		super(desktop, name);
...
class Cessna_CategoryObject_5 extends RigidReferenceFrame
{
	constructor(desktop: IDesktop, name: string)
	{
		super(desktop, name);
...
class Cessna_CategoryObject_7 extends DataConsumer
{
	constructor(desktop: IDesktop, name: string)
	{
		super(desktop, name);
