...
{
    public class OrbitalForecastCalculator : Diagram.UI.PureDesktop
    {
        public OrbitalForecastCalculator()
        {
            objects.Add(new OrbitalForecastCalculator.OblectLabel0("Atmosphere", this));
            objects.Add(new OrbitalForecastCalculator.OblectLabel1("Gravity", this));
            objects.Add(new OrbitalForecastCalculator.OblectLabel2("Vector", this));
            objects.Add(new OrbitalForecastCalculator.OblectLabel3("G-transformation", this));
            objects.Add(new OrbitalForecastCalculator.OblectLabel4("A-transformation", this));
            objects.Add(new OrbitalForecastCalculator.OblectLabel5("Motion equations", this));
            objects.Add(new OrbitalForecastCalculator.OblectLabel6("Recursive", this));
            objects.Add(new OrbitalForecastCalculator.OblectLabel7("Chart", this));
            Diagram.UI.Labels.PureArrowLabel currALabel = null;
            currALabel = new OrbitalForecastCalculator.ArrowLabel0("", this);
            arrows.Add(currALabel);
            currALabel.SourceNumber = (int)3;
            currALabel.TargetNumber = (int)1;
            currALabel = new OrbitalForecastCalculator.ArrowLabel1("", this);
            arrows.Add(currALabel);
            currALabel.SourceNumber = (int)4;
            currALabel.TargetNumber = (int)0;
            currALabel = new OrbitalForecastCalculator.ArrowLabel2("", this);
            arrows.Add(currALabel);
            currALabel.SourceNumber = (int)3;
            currALabel.TargetNumber = (int)2;
            currALabel = new OrbitalForecastCalculator.ArrowLabel3("", this);
            arrows.Add(currALabel);
            currALabel.SourceNumber = (int)4;
            currALabel.TargetNumber = (int)2;
            currALabel = new OrbitalForecastCalculator.ArrowLabel4("", this);
            arrows.Add(currALabel);
            currALabel.SourceNumber = (int)5;
            currALabel.TargetNumber = (int)3;
            currALabel = new OrbitalForecastCalculator.ArrowLabel5("", this);
            arrows.Add(currALabel);
            currALabel.SourceNumber = (int)5;
            currALabel.TargetNumber = (int)4;
            currALabel = new OrbitalForecastCalculator.ArrowLabel6("", this);
            arrows.Add(currALabel);
            currALabel.SourceNumber = (int)5;
            currALabel.TargetNumber = (int)2;
            currALabel = new OrbitalForecastCalculator.ArrowLabel7("", this);
            arrows.Add(currALabel);
            currALabel.SourceNumber = (int)6;
            currALabel.TargetNumber = (int)5;
            currALabel = new OrbitalForecastCalculator.ArrowLabel8("", this);
            arrows.Add(currALabel);
            currALabel.SourceNumber = (int)7;
            currALabel.TargetNumber = (int)6;
            currALabel = new OrbitalForecastCalculator.ArrowLabel9("", this);
            arrows.Add(currALabel);
            currALabel.SourceNumber = (int)7;
            currALabel.TargetNumber = (int)2;
            currALabel = new OrbitalForecastCalculator.ArrowLabel10("", this);
            arrows.Add(currALabel);
            currALabel.SourceNumber = (int)7;
            currALabel.TargetNumber = (int)5;
            bool pl = PostLoad();
            ...
            PostLoad(this);
            Name = "OrbitalForecastCalculator";
        }
            ...
            internal class CategoryObject : DataPerformer.Formula.VectorFormulaConsumer, FormulaEditor.Interfaces.ITreeCollectionProxyFactory
            {
                ...
                internal class Calculation : FormulaEditor.Interfaces.ITreeCollectionProxy
                {
                    ...
                    internal Calculation(FormulaEditor.ObjectFormulaTree[] trees, Func<object, bool> checkValue, DataPerformer.Formula.DataPerformerFormula dataPerformerFormula)
                    {
                        ...
                        aliasName13 = dataPerformerFormula.ToAliasName(trees[13]);
            ...
            ,           { 'w' ,"Vector.w" }
                ...
                internal class Calculation : FormulaEditor.Interfaces.ITreeCollectionProxy
                {
                    ...
                    public void Update()
                    {
                        ...
                        variable = measurement27.Parameter();
                        if (checkValue(variable)) { success = false; return; }
                    ...
                    internal Calculation(FormulaEditor.ObjectFormulaTree[] trees, Func<object, bool> checkValue, DataPerformer.Formula.DataPerformerFormula dataPerformerFormula)
                    {
                        ...
                        measurement17 = dataPerformerFormula.ToMeasurement(trees[17]);
                        measurement18 = dataPerformerFormula.ToMeasurement(trees[18]);
                        measurement27 = dataPerformerFormula.ToMeasurement(trees[27]);
                    ...
                    DataPerformer.Interfaces.IMeasurement measurement18;
                    DataPerformer.Interfaces.IMeasurement measurement27;
