...
public class OrbitalForecast extends Desktop
{
			...
			public CategoryObject7(String name, IDesktop desktop) {
				...
				setMap(map);
						...
						protected void calculateTree()
						{
							...
							var_21[0] = ((double[])measurement21.getMeasurementValue();
							if (check(var_21)) { success = false; return; } 
							var_22[0] = ((var_21[0]) & (var_5[0]));
							if (check(var_22)) { success = false; return; } 
							var_24[0] = ((double[])measurement24.getMeasurementValue();
							...
							var_31[0] = ((double[])measurement31.getMeasurementValue();
		...
		protected class CategoryObject8 extends measurements.VectorFormulaConsumer
		{
			public CategoryObject8(String name, IDesktop desktop) {
				...
				setMap(map);
						...
						{
							success = true;
							var_0[0] = ((double[])measurement0.getMeasurementValue();
							if (check(var_0)) { success = false; return; } 
							var_3[0] = ((var_0[0]) ? (var_1[0]) : (var_2[0]));
							if (check(var_3)) { success = false; return; } 
							var_4[0] = ((double[])measurement4.getMeasurementValue();
							if (check(var_4)) { success = false; return; } 
							var_7[0] = ((var_4[0]) ? (var_5[0]) : (var_6[0]));
							if (check(var_7)) { success = false; return; } 
							var_8[0] = ((double[])measurement8.getMeasurementValue();
							if (check(var_8)) { success = false; return; } 
							var_11[0] = ((var_8[0]) ? (var_9[0]) : (var_10[0]));
							if (check(var_11)) { success = false; return; } 
							var_12[0] = ((double[])measurement12.getMeasurementValue();
							if (check(var_12)) { success = false; return; } 
							var_15[0] = ((var_12[0]) ? (var_13[0]) : (var_14[0]));
							if (check(var_15)) { success = false; return; } 
							var_16[0] = ((double[])measurement16.getMeasurementValue();
							if (check(var_16)) { success = false; return; } 
	...
	public void init()
	{
			new OrbitalForecast.CategoryObject0("Trading", this);
			new OrbitalForecast.CategoryObject1("Average Short", this);
			new OrbitalForecast.CategoryObject2("Average Long", this);
			new OrbitalForecast.CategoryObject3("Donchian maximum", this);
			new OrbitalForecast.CategoryObject4("Donchian minimum", this);
			new OrbitalForecast.CategoryObject5("Current Position", this);
			new OrbitalForecast.CategoryObject6("Conditions", this);
			new OrbitalForecast.CategoryObject7("Sell Buy", this);
			new OrbitalForecast.CategoryObject8("Additional", this);
			new OrbitalForecast.CategoryObject9("Position", this);
			new OrbitalForecast.CategoryObject10("Order", this);
			new OrbitalForecast.CategoryObject11("Chart", this);
			...
			new OrbitalForecast.CategoryArrow12("", this);
			new OrbitalForecast.CategoryArrow13("", this);
			new OrbitalForecast.CategoryArrow14("", this);
			new OrbitalForecast.CategoryArrow15("", this);
			new OrbitalForecast.CategoryArrow16("", this);
			new OrbitalForecast.CategoryArrow17("", this);
			new OrbitalForecast.CategoryArrow18("", this);
			new OrbitalForecast.CategoryArrow19("", this);
			new OrbitalForecast.CategoryArrow20("", this);
			new OrbitalForecast.CategoryArrow21("", this);
			new OrbitalForecast.CategoryArrow22("", this);
			new OrbitalForecast.CategoryArrow23("", this);
			new OrbitalForecast.CategoryArrow24("", this);
			new OrbitalForecast.CategoryArrow25("", this);
			new OrbitalForecast.CategoryArrow26("", this);
			new OrbitalForecast.CategoryArrow27("", this);
			new OrbitalForecast.CategoryArrow28("", this);
			new OrbitalForecast.CategoryArrow29("", this);
