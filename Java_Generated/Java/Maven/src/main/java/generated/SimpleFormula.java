...
public class SimpleFormula extends Desktop
{
	...
	public  SimpleFormula(ICheck check, IErrorHandler errorHandler) {
	...
	public void init()
	{
		new  SimpleFormula.CategoryObject0("X", this);
		new  SimpleFormula.CategoryObject1("Chart", this);
		new  SimpleFormula.CategoryArrow0("", this);
