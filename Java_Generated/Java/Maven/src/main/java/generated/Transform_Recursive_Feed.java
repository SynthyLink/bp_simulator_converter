...
public class Transform_Recursive_Feed extends Desktop
{
    ...
    protected class CategoryObject0 extends measurements.VectorFormulaConsumer
	{
		public CategoryObject0(String name, IDesktop desktop) {
			...
			map.put("c", new general_service.Entry<Object, Object>(new double[0], new double[]{0.52807755064538875}));
			map.put("a", new general_service.Entry<Object, Object>(new double[0], new double[]{0.19288703216830558}));
			map.put("d", new general_service.Entry<Object, Object>(new double[0], new double[]{9}));
			map.put("b", new general_service.Entry<Object, Object>(new double[0], new double[]{0.0021040127874554378}));
			setMap(map);
					Object o;
					o = new double[0];
	...
	protected class CategoryObject3 extends measurements.RecursiveFormula
	{
		public CategoryObject3(String name, IDesktop desktop) {
			...
			setMap(map);
					...
					o = new double[0];
					addVariableValue("c", o);
					o = new double[0];
					addVariableValue("d", o);
					o = new double[0];
					addVariableValue("f", o);
				}
	...
	public Transform_Recursive_Feed() {
		super();
	}

	public Transform_Recursive_Feed(ICheck check, IErrorHandler errorHandler) {
	...
	public void init()
	{
		new Transform_Recursive_Feed.CategoryObject0("Vector", this);
		new Transform_Recursive_Feed.CategoryObject1("Source", this);
		new Transform_Recursive_Feed.CategoryObject2("Transformer", this);
		new Transform_Recursive_Feed.CategoryObject3("Recursive", this);
		new Transform_Recursive_Feed.CategoryObject4("Chart", this);
		new Transform_Recursive_Feed.CategoryArrow0("", this);
		new Transform_Recursive_Feed.CategoryArrow1("", this);
		new Transform_Recursive_Feed.CategoryArrow2("", this);
		new Transform_Recursive_Feed.CategoryArrow3("", this);
		new Transform_Recursive_Feed.CategoryArrow4("", this);
		new Transform_Recursive_Feed.CategoryArrow5("", this);
