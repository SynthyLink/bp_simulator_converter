    ...
    suspend fun connect(host: String, port: Int): Boolean = withContext(Dispatchers.IO) {
        try {
            ...
            if (success) {
                ...
                socketChannel = null // Clear the SocketChannel if we decide to use blocking Socket
                return@withContext true // Placeholder, will be replaced by actual blocking Socket logic
            }
