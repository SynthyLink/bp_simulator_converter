...
public class Gravity36x36
{
    ...
    public void Forces(double X, double Y, double Z, double[] FX,
                       double[] FY, double[] FZ)
    {
        Forces(n0, nk, X, Y, Z,  FX,  FY, FZ);
    }
    ...
    /// <param name="FY">Y - component of gravitational acceleration</param>
    /// <param name="FZ">Z - component of gravitational acceleration</param>
    public void Forces(int N0, int NK, double X, double Y, double Z, double[] FX,
                       double[] FY,  double[] FZ)
    {
        boolean LOG;
        ...
        FL = -GR / CF[0] * FL;
        A = FF * SF;
        FX[0] = FR * (X * R1) - A * CO[0] - FL * SI[0];
        FY[0] = FR * (Y * R1) - A * SI[0] + FL * CO[0];
        FZ[0] = FR * SF + FF * CF[0];
