...
public class FormulaComposition extends Desktop
{
	...
	public FormulaComposition() {
		super();
	}

	public FormulaComposition(ICheck check, IErrorHandler errorHandler) {
	...
	public void init()
	{
		new FormulaComposition.CategoryObject0("X", this);
		new FormulaComposition.CategoryObject1("Y", this);
		new FormulaComposition.CategoryObject2("Chart", this);
		new FormulaComposition.CategoryArrow0("", this);
		new FormulaComposition.CategoryArrow1("", this);
