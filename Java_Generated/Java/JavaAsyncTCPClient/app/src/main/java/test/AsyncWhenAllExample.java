...
import communication.IByteReceiver;
import error_handler.KotlinErrorHandler;

public class AsyncWhenAllExample {

   static KotlinErrorHandler ke = new KotlinErrorHandler();
    ...
    public static CompletableFuture<String> simulateAsyncOperation(String data) {
        return CompletableFuture.supplyAsync(() -> {
            try {
                ...
                ConsoleByteReceiver r = new ConsoleByteReceiver();

                var aa = (IByteReceiver)r;

                var c = new AsyncTcpClient("31.10.82.229",7168, aa, true);
